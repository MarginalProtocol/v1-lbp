...
def test_integration_quoter_quote_exact_input_single__quotes_swap_when_not_clamped(
    margv1lb_router,
    ...
    amount_specified = 1 * reserve0 // 100 if zero_for_one else 1 * reserve1 // 100
    ...
    result = margv1_quoter.quoteExactInputSingle(params)
    margv1lb_router.exactInputSingle(params, sender=sender)
...
@pytest.mark.parametrize("zero_for_one", [True, False])
@pytest.mark.parametrize("init_with_sqrt_price_lower_x96", [True, False])
def test_integration_quoter_quote_exact_input_single__quotes_swap_when_clamped(
    margv1lb_router,
    margv1_pool_initialized,
    margv1_quoter,
    margv1_token0,
    ...
    amount_specified = amount0_swap if zero_for_one else amount1_swap
